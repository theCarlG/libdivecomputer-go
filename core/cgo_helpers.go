...
// Ref returns a reference to C object as it is.
func (x *Iostream) Ref() *C.dc_iostream_t {
	if x == nil {
		return nil
	}
	return (*C.dc_iostream_t)(unsafe.Pointer(x))
}

// Free cleanups the referenced memory using C free.
func (x *Iostream) Free() {
	if x != nil {
		C.free(unsafe.Pointer(x))
	}
}

// NewIostreamRef converts the C object reference into a raw struct reference without wrapping.
func NewIostreamRef(ref unsafe.Pointer) *Iostream {
	return (*Iostream)(ref)
}

// NewIostream allocates a new C object of this type and converts the reference into
// a raw struct reference without wrapping.
func NewIostream() *Iostream {
	return (*Iostream)(allocIostreamMemory(1))
}

// allocIostreamMemory allocates memory for type C.dc_iostream_t in C.
// The caller is responsible for freeing the this memory via C.free.
func allocIostreamMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfIostreamValue))
	if err != nil {
		panic("memory alloc error: " + err.Error())
	}
	return mem
...
const sizeOfIostreamValue = unsafe.Sizeof([1]C.dc_iostream_t{})

// PassRef returns a reference to C object as it is or allocates a new C object of this type.
func (x *Iostream) PassRef() *C.dc_iostream_t {
	if x == nil {
		x = (*Iostream)(allocIostreamMemory(1))
	}
	return (*C.dc_iostream_t)(unsafe.Pointer(x))
}
...
// Ref returns a reference to C object as it is.
func (x *BluetoothDevice) Ref() *C.dc_bluetooth_device_t {
	if x == nil {
		return nil
	}
	return (*C.dc_bluetooth_device_t)(unsafe.Pointer(x))
}

// Free cleanups the referenced memory using C free.
func (x *BluetoothDevice) Free() {
	if x != nil {
		C.free(unsafe.Pointer(x))
	}
}

// NewBluetoothDeviceRef converts the C object reference into a raw struct reference without wrapping.
func NewBluetoothDeviceRef(ref unsafe.Pointer) *BluetoothDevice {
	return (*BluetoothDevice)(ref)
}

// NewBluetoothDevice allocates a new C object of this type and converts the reference into
// a raw struct reference without wrapping.
func NewBluetoothDevice() *BluetoothDevice {
	return (*BluetoothDevice)(allocBluetoothDeviceMemory(1))
}

// allocBluetoothDeviceMemory allocates memory for type C.dc_bluetooth_device_t in C.
// The caller is responsible for freeing the this memory via C.free.
func allocBluetoothDeviceMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfBluetoothDeviceValue))
	if err != nil {
		panic("memory alloc error: " + err.Error())
	}
	return mem
...
const sizeOfBluetoothDeviceValue = unsafe.Sizeof([1]C.dc_bluetooth_device_t{})

// PassRef returns a reference to C object as it is or allocates a new C object of this type.
func (x *BluetoothDevice) PassRef() *C.dc_bluetooth_device_t {
	if x == nil {
		x = (*BluetoothDevice)(allocBluetoothDeviceMemory(1))
	}
	return (*C.dc_bluetooth_device_t)(unsafe.Pointer(x))
}

// Ref returns a reference to C object as it is.
func (x *CustomCbs) Ref() *C.dc_custom_cbs_t {
	if x == nil {
		return nil
	}
	return (*C.dc_custom_cbs_t)(unsafe.Pointer(x))
}

// Free cleanups the referenced memory using C free.
func (x *CustomCbs) Free() {
	if x != nil {
		C.free(unsafe.Pointer(x))
	}
}

// NewCustomCbsRef converts the C object reference into a raw struct reference without wrapping.
func NewCustomCbsRef(ref unsafe.Pointer) *CustomCbs {
	return (*CustomCbs)(ref)
}

// NewCustomCbs allocates a new C object of this type and converts the reference into
// a raw struct reference without wrapping.
func NewCustomCbs() *CustomCbs {
	return (*CustomCbs)(allocCustomCbsMemory(1))
}

// allocCustomCbsMemory allocates memory for type C.dc_custom_cbs_t in C.
// The caller is responsible for freeing the this memory via C.free.
func allocCustomCbsMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfCustomCbsValue))
	if err != nil {
		panic("memory alloc error: " + err.Error())
	}
	return mem
...
const sizeOfCustomCbsValue = unsafe.Sizeof([1]C.dc_custom_cbs_t{})

// PassRef returns a reference to C object as it is or allocates a new C object of this type.
func (x *CustomCbs) PassRef() *C.dc_custom_cbs_t {
	if x == nil {
		x = (*CustomCbs)(allocCustomCbsMemory(1))
	}
	return (*C.dc_custom_cbs_t)(unsafe.Pointer(x))
}

// Ref returns a reference to C object as it is.
func (x *IrdaDevice) Ref() *C.dc_irda_device_t {
	if x == nil {
		return nil
	}
	return (*C.dc_irda_device_t)(unsafe.Pointer(x))
}

// Free cleanups the referenced memory using C free.
func (x *IrdaDevice) Free() {
	if x != nil {
		C.free(unsafe.Pointer(x))
	}
}

// NewIrdaDeviceRef converts the C object reference into a raw struct reference without wrapping.
func NewIrdaDeviceRef(ref unsafe.Pointer) *IrdaDevice {
	return (*IrdaDevice)(ref)
}

// NewIrdaDevice allocates a new C object of this type and converts the reference into
// a raw struct reference without wrapping.
func NewIrdaDevice() *IrdaDevice {
	return (*IrdaDevice)(allocIrdaDeviceMemory(1))
}

// allocIrdaDeviceMemory allocates memory for type C.dc_irda_device_t in C.
// The caller is responsible for freeing the this memory via C.free.
func allocIrdaDeviceMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfIrdaDeviceValue))
	if err != nil {
		panic("memory alloc error: " + err.Error())
	}
	return mem
...
const sizeOfIrdaDeviceValue = unsafe.Sizeof([1]C.dc_irda_device_t{})

// PassRef returns a reference to C object as it is or allocates a new C object of this type.
func (x *IrdaDevice) PassRef() *C.dc_irda_device_t {
	if x == nil {
		x = (*IrdaDevice)(allocIrdaDeviceMemory(1))
	}
	return (*C.dc_irda_device_t)(unsafe.Pointer(x))
}

// Ref returns a reference to C object as it is.
func (x *SerialDevice) Ref() *C.dc_serial_device_t {
	if x == nil {
		return nil
	}
	return (*C.dc_serial_device_t)(unsafe.Pointer(x))
}

// Free cleanups the referenced memory using C free.
func (x *SerialDevice) Free() {
	if x != nil {
		C.free(unsafe.Pointer(x))
	}
}

// NewSerialDeviceRef converts the C object reference into a raw struct reference without wrapping.
func NewSerialDeviceRef(ref unsafe.Pointer) *SerialDevice {
	return (*SerialDevice)(ref)
}

// NewSerialDevice allocates a new C object of this type and converts the reference into
// a raw struct reference without wrapping.
func NewSerialDevice() *SerialDevice {
	return (*SerialDevice)(allocSerialDeviceMemory(1))
}

// allocSerialDeviceMemory allocates memory for type C.dc_serial_device_t in C.
// The caller is responsible for freeing the this memory via C.free.
func allocSerialDeviceMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfSerialDeviceValue))
	if err != nil {
		panic("memory alloc error: " + err.Error())
	}
	return mem
...
const sizeOfSerialDeviceValue = unsafe.Sizeof([1]C.dc_serial_device_t{})

// PassRef returns a reference to C object as it is or allocates a new C object of this type.
func (x *SerialDevice) PassRef() *C.dc_serial_device_t {
	if x == nil {
		x = (*SerialDevice)(allocSerialDeviceMemory(1))
	}
	return (*C.dc_serial_device_t)(unsafe.Pointer(x))
}

// Ref returns a reference to C object as it is.
func (x *UsbhidDevice) Ref() *C.dc_usbhid_device_t {
	if x == nil {
		return nil
	}
	return (*C.dc_usbhid_device_t)(unsafe.Pointer(x))
}

// Free cleanups the referenced memory using C free.
func (x *UsbhidDevice) Free() {
	if x != nil {
		C.free(unsafe.Pointer(x))
	}
}

// NewUsbhidDeviceRef converts the C object reference into a raw struct reference without wrapping.
func NewUsbhidDeviceRef(ref unsafe.Pointer) *UsbhidDevice {
	return (*UsbhidDevice)(ref)
}

// NewUsbhidDevice allocates a new C object of this type and converts the reference into
// a raw struct reference without wrapping.
func NewUsbhidDevice() *UsbhidDevice {
	return (*UsbhidDevice)(allocUsbhidDeviceMemory(1))
}

// allocUsbhidDeviceMemory allocates memory for type C.dc_usbhid_device_t in C.
// The caller is responsible for freeing the this memory via C.free.
func allocUsbhidDeviceMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfUsbhidDeviceValue))
	if err != nil {
		panic("memory alloc error: " + err.Error())
	}
	return mem
...
const sizeOfUsbhidDeviceValue = unsafe.Sizeof([1]C.dc_usbhid_device_t{})

// PassRef returns a reference to C object as it is or allocates a new C object of this type.
func (x *UsbhidDevice) PassRef() *C.dc_usbhid_device_t {
	if x == nil {
		x = (*UsbhidDevice)(allocUsbhidDeviceMemory(1))
	}
	return (*C.dc_usbhid_device_t)(unsafe.Pointer(x))
}
